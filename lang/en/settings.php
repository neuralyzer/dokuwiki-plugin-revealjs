...
$lang['horizontal_slide_level'] = "Headers on this level or above starting a horizontal slide. Levels below starting a vertical (nested) slide - no effect on slides, which are indicated by alternative slide indicators (<nobr>----></nobr> and <nobr>---->></nobr>)";
$lang['enlarge_vertical_slide_headers'] = "Enlarge headers on slides below horizontal_slide_level - no effect on slides, which are indicated by alternative slide indicators (<nobr>----></nobr> and <nobr>---->></nobr>)";
$lang['show_image_borders'] = "Show image borders (default in Reveal.js)";
